...
export class addUserAndUserDevicesTables1641635415608 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "auth_schema"."user_devices" ("id" SERIAL NOT NULL, "device_id" character varying(500) NOT NULL, "app_version" character varying(100) NOT NULL, "notification_token" character varying(500), "access_token" character varying(4000), "refresh_token" character varying(4000), "timezone" character varying(500) NOT NULL, "status" character varying(100) NOT NULL DEFAULT 'ACTIVE', "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, "user_id" integer, CONSTRAINT "PK_c22191d0416fc8ef791d443b81c" PRIMARY KEY ("id"))`);
